...
FAKE_CATEGORY_DATA = {
	0 : {
		"categoryName" : "Deðerli Nesneler",
		"subCategoryNameList" : ["Nesneler"],
	},
	1 : {
		"categoryName" : "Saldýrý D. Kostüm",
		"subCategoryNameList" : ["Erkek", "Kadýn"],
	},
	2 : {
		"categoryName" : "Büyü Hýzý Kostüm",
		"subCategoryNameList" : ["Erkek", "Kadýn"],
	},
	3 : {
		"categoryName" : "Saç Stili",
		"subCategoryNameList" : ["Erkek", "Kadýn"],
	},
	4 : {
		"categoryName" : "Silah Fiþi",
		"subCategoryNameList" : ["Kýlýç", "Çift-el", "Býçak", "Yay", "Çan", "Yelpaze"],
	},
	5 : {
		"categoryName" : "Kanat",
		"subCategoryNameList" : ["Premium Kanatlar", "Kanatlar"],
	},
	6 : {
		"categoryName" : "Petler",
		"subCategoryNameList" : ["Pet"],
	},
...
class CategoryBoard(ui.Window):
	...
	def OnScroll(self):
		scrollLineCount = len(self.showingItemList) - 11
	...
	def __LocateMember(self):
		...
		if self.showingItemList:
			stepSize = 1.0 / (len(self.showingItemList) - 10)
	...
	def RefreshProcess(self):
		...
		for i in xrange(len(FAKE_CATEGORY_DATA)):
			...
			category = CategoryListItem(self, 10, 15 + i * 30)
			category.SetKey(i)
...
class ItemShopWindow(ui.ScriptWindow):
	...
	def RenderTargetBaoard(self):
		...
		renderTarget.SetBackground(6, "d:/ymir work/ui/game/myshop_deco/model_view_bg.sub", player.GetRace(), 0)
	...
	def coinButtonEvent(self):
		if self.interface:
			self.interface.OpenWebWindow("https://runikac.com")
	...
	def previewButtonEvent(self, itemVnum, itemType, itemSubType, itemValue, itemAffect, itemHair):
		...
		if itemType == item.ITEM_TYPE_COSTUME and itemSubType == item.COSTUME_TYPE_ACCE:
			renderTarget.SetAcce(6, itemVnum, player.GetRace())
		if item.ITEM_TYPE_UNIQUE == itemType and itemSubType == item.USE_PET:
			renderTarget.SelectModel(6, itemValue)
		if itemType == item.ITEM_TYPE_COSTUME and itemSubType == item.COSTUME_TYPE_MOUNT:
			renderTarget.SelectModel(6, itemValue)

				
	#def ShowShamanModel(self):
		#renderTarget.SelectRenderModel(6, 3)
		#renderTarget.SetArmor(6, 20759)
		#renderTarget.SetHair(6, 0)
		#renderTarget.SetWeapon(6, 7199)
		#renderTarget.SetVisibility(6, True)
